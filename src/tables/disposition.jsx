          ...
          <tr className="border-b-2 bg-[#00A6B4]/[0.5] text-sm">
            {headers.map((item, index) => (
              ...
              className={`py-3 px-6 uppercase ${
                item === "id" || item === "userdomain"  || item === "memoReviewer" || item === "userdomainreviewer" || item === "memoUpload" || item === "idMemo" || item === "userdomainpic"
                    ? "hidden"
                    : ""
            }`}
              >
            ...
            return (
              ...
              >
                {headers.map((header, headerIndex) => (
                  <td key={headerIndex}
                  className={`py-3 px-6 ${
                    header === "id" || header === "userdomain"  || header === "memoReviewer" || header === "userdomainreviewer" || header === "memoUpload" || header === "idMemo" || header === "userdomainpic" ? "hidden" : ""
                }`}
                   >
