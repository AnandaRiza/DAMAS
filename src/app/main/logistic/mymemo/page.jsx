  ...
  const getDataAllMemo = async () => {
    ...
    try {
      const response = await axios.get(
        `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/allmemo/pic?start=${startIndex}&size=${perPage}&userdomain=${user.userdomain}`
      );
      console.log("API Response:", response); // Log the full response

      // Log entire response object to inspect its structure
