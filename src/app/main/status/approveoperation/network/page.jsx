...
import Body from "@/components/operation/network/body/operation_network_log";
import Header from "@/components/operation/network/header/header_log";
...
const Page = () => {
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationnetwork/getnetworklog?input=${searchInput}`
            );
