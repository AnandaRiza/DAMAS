...
import Body from "@/components/operation/itmo/body/operation_itmo_log";
import Header from "@/components/operation/itmo/header/header_log";
...
const Page = () => {
    ...
    const getAllDataLog = async () => {
        ...
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationitmolog?start=${startIndex}&size=${perPage}`
            );
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationitmo/getitmolog?input=${searchInput}`
            );
