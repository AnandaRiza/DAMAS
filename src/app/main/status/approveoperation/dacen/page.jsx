...
import Body from "@/components/operation/datacenter/body/operation_datacenter_log";
import Header from "@/components/operation/datacenter/header/header_log";
...
const Page = () => {
    ...
    const getAllDataLog = async () => {
        ...
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationdacenlog?start=${startIndex}&size=${perPage}`
            );
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationdacen/getdacenlog?input=${searchInput}`
            );
