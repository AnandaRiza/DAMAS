...
import Body from "@/components/operation/itsecurity/body/operation_itsecurity_log";
import Header from "@/components/operation/itsecurity/header/header_log";
...
const Page = () => {
    ...
    const getAllDataLog = async () => {
        ...
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationitsecuritylog?start=${startIndex}&size=${perPage}`
            );
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_DAMAS_URL_SERVER}/operationitsecuritylog/getitsecuritylog?input=${searchInput}`
            );
