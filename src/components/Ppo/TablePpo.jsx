                        ...
                        >
                            {headers.map((header, headerIndex) => (
                                <td
                                    key={headerIndex}
                                    className={`py-3 px-6 ${
                                        header === "id"  || header === "kickoffstart"  || header === "kickoffdeadline" || header === "kickoffdone" || header === "userrequirementstart" || header === "userrequirementdeadline" || header === "userrequirementdone" || header === "applicationdevelopmentstart" || header === "applicationdevelopmentdeadline" || header === "applicationdevelopmentdone" || header === "sitstart" || header === "sitdeadline" || header === "sitdone" || header === "uatstart" || header === "uatdeadline" || header === "uatdone" || header === "implementationpreparestart" || header === "implementationpreparedeadline" || header === "implementationpreparedone" || header === "implementationmeetingstart" || header === "implementationmeetingdeadline" || header === "implementationmeetingdone" || header === "implementationstart" || header === "implementationdeadline" || header === "implementationdone" || header === "postimplementationreviewstart" || header === "postimplementationreviewdeadline" || header === "postimplementationreviewdone" || header === "projectdone"
