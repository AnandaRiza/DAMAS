    ...
    const sortedData = useMemo(() => {
        return data.slice().sort((a, b) => {
            const classA = rowClass(
                convertToDateCalculate(a.memoDeadline),
                a.memoStatus
            );
            const classB = rowClass(
                convertToDateCalculate(b.memoDeadline),
                b.memoStatus
            );
            ...
            if (a.memoStatus === "Ongoing" && b.memoStatus === "Ongoing") {
                return (
                    new Date(convertToDateCalculate(a.memoDeadline)) -
                    new Date(convertToDateCalculate(b.memoDeadline))
                );
            }
                                ...
                                {headers.map((header, headerIndex) => (
                                    <td
                                        ...
                                        className={`py-3 px-6 ${
                                            ...
                                            header === "userdomain" ||
                                            header === "memoNotes" ||
                                            header === "memoCreatedBy" ||
                                            header === "memoReviewer" ||
                                            header === "memoKeluar" ||
                                            header === "userdomainreviewer" ||
                                            header === "memoUpload" ||
                                            header === "idMemo" ||
                                            header === "userdomainpic"
                                                ? "hidden"
                                                : ""
                                        }`}
                                    >
