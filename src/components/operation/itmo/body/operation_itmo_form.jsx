...
const page = () => {
  ...
  const handleSubmit = async () => {
    try {
      await axios.post("http://localhost:8081/api/operationitmo", formData);
          ...
          <form className="space-y-4">
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase1_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase1_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase1_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase2_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase2_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase2_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase3_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase3_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase3_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase4_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase4_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase4_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase5_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase5_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase6_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase6_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase6_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase7_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase7_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itmo_phase7_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                id="deadline"
                name="deadline"
                value={formData.itmo_deadline_project}
                onChange={(e) =>
                  setFormData({
                    ...formData,
            ...
            <div className="flex flex-col">
                ...
                <div className="dropdown mt-1 ">
                    <div tabIndex={0} role="button" className="btn m-1 w-52 bg-white hover:bg-gray text-gray-600">
                        {formData.itmo_status ? formData.itmo_status : "Select Status"}
                    </div>
                    <ul
                        tabIndex={0}
