...
import { IsItmoOperator, IsOperator } from "@/validation/validateGroupAkses";
            ...
            <table className="table">
                <thead>
                    <tr className="border-b-2 bg-[#00A6B4] text-sm">
                        ...
                        {(IsOperator() || IsItmoOperator()) && action && (
                    ...
                    {sortedData.map((item, index) => {
                        ...
                        return (
                            <tr
                                ...
                                onDoubleClick={() =>
                                    handleDoubleClick(item.itmo_id)
                                }
                            >
                                ...
                                {(IsOperator() || IsItmoOperator()) &&
                                    action && (
                                        <td className="py-3 px-6 w-32 flex items-center justify-center gap-3">
                                            <button
                                                type="button"
                                                onClick={() =>
                                                    handleEdit(item.itmo_id)
                                                }
