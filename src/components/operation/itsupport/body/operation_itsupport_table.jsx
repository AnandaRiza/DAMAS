...
const page = ({headers, data, action, link}) => {
    ...
    const sortedData = data.slice().sort((a, b) => {
        ...
        if (a.itsupport_status === "Ongoing" && b.itsupport_status === "Ongoing") {
            ...
            return new Date(a.itsupport_deadline_project) - new Date(b.itsupport_deadline_project);
        }
...
return (
    ...
    <table className="table">
        ...
        <tbody>
            ...
            const rowClassName = rowClass(item.itsupport_deadline_project, item.itsupport_status);
