                ...
                >
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="namaphase1"
                      name="namaphase1"
                      value={formData.itsecurity_phase1}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase1_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase1_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase1_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="namaphase1"
                      name="namaphase1"
                      value={formData.itsecurity_phase2}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase2_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase2_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase2_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase3_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase3_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase3_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase4_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase4_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase4_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="namaphase1"
                      name="namaphase1"
                      value={formData.itsecurity_phase5}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase5_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase5_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="namaphase1"
                      name="namaphase1"
                      value={formData.itsecurity_phase6}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase6_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase6_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase6_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="namaphase1"
                      name="namaphase1"
                      value={formData.itsecurity_phase7}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          itsecurity_phase6: e.target.value,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase7_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase7_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.itsecurity_phase7_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
