...
const page = () => {
  ...
  const handleSubmit = async () => {
    try {
      await axios.post("http://localhost:8081/api/operationdacen", formData);
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase1_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase1_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase1_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase2_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase2_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase2_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase3_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase3_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase3_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase4_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase4_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase4_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase5_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase5_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase6_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase6_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase6_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                ...
                >
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase7_start}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase7_deadline}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                  ...
                  {/* <div className="flex flex-col mx-3 my-3">
                    ...
                    <input
                      ...
                      id="deadline"
                      name="deadline"
                      value={formData.dacen_phase7_done}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
