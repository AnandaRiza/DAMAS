...
const Page = () => {
  ...
  return (
    <div className="flex-grow bg-[#FFFFFF] justify-center items-center min-h-screen bg-white rounded-xl">
      <div className="px-10 grid grid-cols-2 gap-3 mt-4 w-full p-4">
        <div class="flex w-full">
          <details className="dropdown">
            <summary className="btn m-1 w-[200px] h-[100px] p-2">
              {selectedOption
          ...
          <div class="card bg-[#87FF81] rounded-box grid w-[200px] h-[100px] p-2 m-1 ml-10 flex-grow place-items-center">
            <h2 className="text-[#112A46]">Jumlah Project</h2>
            <h4 className="text-[#112A46]">142</h4>
          </div>
          <div class="card bg-base-300 rounded-box grid w-[200px] h-[100px] p-2 m-1 ml-10 flex-grow place-items-center">
      ...
      {componentToDisplay && <div className="mt-1">{componentToDisplay}</div>}
    </div>
  );
};
